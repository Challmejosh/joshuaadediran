...
const Navbar = ()=>{
    ...
    return(
        <div className={`hidden lg:flex flex-col items-start justify-center w-[200px] pt-3 gap-5 h-screen text-xs  fixed top-0 right-0 z-50   `}>
            <div className="hidden lg:flex flex-col gap-5 w-full items-center justify-center ">
                <motion.div className={`${!openMenu && " absolute top-11"} p-1 w-[150px] h-fit gap-3 flex items-center justify-start  `}
